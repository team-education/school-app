    ...
    <main>
      <div className="header-area">
        ...
        <div className="image-container">
          <img src={image4} alt="Image 4" className="image-size" />
        </div>
      </div>
      ...
      <div className="image-container">
        <div>
          <img src={image1} alt="Image 1" className="size-image" />
          <h3>Chidi Ononye - co-founder</h3>
        </div>

        <div>
          <img src={image2} alt="Image 2" className="size-image" />
          <h3>Qasim Aswan - co-founder</h3>
        </div>

        <div>
          <img src={image3} alt="Image 3" className="size-image" />
